  ...
  return (
    <section>
      <div className="flex justify-between items-center my-8">
        <div>
          <h1 className="text-3xl font-semibold dark:text-white lg:text-4xl">{word}</h1>
      ...
      <div>
        ...
        <div className="flex items-center">
          <a className="text-sm mr-2 underline dark:text-white lg:text-md overflow-hidden" href={entryData?.sourceUrls[0]}>
